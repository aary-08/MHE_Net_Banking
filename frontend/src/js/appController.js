  ...
  function (ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
    ...
    function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'register', detail: { label: 'Register', iconClass: 'oj-ux-ico-add-contact' } },
        { path: 'login', detail: { label: 'Login', iconClass: 'oj-ux-ico-lock' } },
        { path: 'accounts', detail: { label: 'Accounts', iconClass: 'oj-ux-ico-bank' } }, 
        { path: 'newaccount', detail: { label: 'New Account', iconClass: 'oj-ux-ico-add' } },
        { path: 'card', detail: { label: 'Cards', iconClass: 'oj-ux-ico-credit-card' } },
        { path: 'fundtransfer', detail: { label: 'Fund Transfer', iconClass: 'oj-ux-ico-arrow-right' } },
        { path: 'transactions', detail: { label: 'Transactions', iconClass: 'oj-ux-ico-restore-clock' } },
      ...
      // 🔥 THIS determines if nav bar, drawer, header, etc. should show
      this.showNavBar = ko.pureComputed(() => {
        const state = router.state && router.state();
